#!/usr/bin/env python3
"""Simple seed script for Care Transition Companion"""
...
def seed_users():
    """Seed users with simple password hash"""
    db = SessionLocal()
    try:
        users = [
            {
                "email": "nurse@hospital.com",
                "password_hash": "simple_hash_nurse",  # Simple hash for demo
                "role": "nurse"
            },
            {
                "email": "admin@hospital.com", 
                "password_hash": "simple_hash_admin",  # Simple hash for demo
                "role": "admin"
            }
        ]
